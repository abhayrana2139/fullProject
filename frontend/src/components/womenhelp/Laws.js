...
<div className='h-[500px] w-[80%]  text-black  m-auto bg-red-50 overflow-scroll'  >
  <div className='bg-black text-white  w-100% text-center font-semibold text-[30px] font-bold  justify-center '>
LAWS AND ACTS
</div>
<div className='font-semibold text-[20px]  pt-4 overflow-scroll'>
